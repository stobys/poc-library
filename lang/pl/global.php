...
return [
    ...
    'different-range'                      => 'Inny Zakres',
    'downloadFile'                         => 'Pobierz plik',
    'edit'                                 => 'Edytuj',
    'emailVerificationSuccess'             => 'User email verified successfully',
    'entries'                              => 'Entries',
    'filterDate'                           => 'Filter by date',
    'filterContactsList'                   => 'Przeszukaj Listę Kontaktów',
    'filterLinksList'                      => 'Przeszukaj Listę Linków',
    'forgot_password'                      => 'Zapomniałeś hasła?',
    'home'                                 => 'Home',
    'list'                                 => 'Lista',
    'login'                                => 'Zaloguj',
    'login_username'                       => 'Global ID',
    'login_email'                          => 'Email',
    'login_password'                       => 'Hasło',
    'login_password_confirmation'          => 'Potwierdzenie Hasła',
    'logout'                               => 'Wyloguj',
    ...
    'noContactsOnTheList'                  => 'Brak Kontaktów na liście',
    ...
    'days'  => [
            'short' => ['Pn', 'Wt', 'Śr', 'Czw', 'Pt', 'Sb', 'Nd'],
            'full'  => ['Poniedziałek', 'Wtorek', 'Środa', 'Czwartek', 'Piątek', 'Sobota', 'Niedziela']
        ],

    'months'    => [
        'short' => ['Sty', 'Lut', 'Mar', 'Kwi', 'Maj', 'Czer', 'Lip', 'Sie', 'Wrz', 'Paź', 'Lis', 'Gru'],
        'full'  => ['Styczeń','Luty','Marzec','Kwiecień','Maj','Czerwiec','Lipiec',
