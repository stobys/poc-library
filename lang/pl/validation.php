...
return [
    ...
    */
    ...
    'exists-in-dict-or-alias'  => 'Pole ":attribute" musi istnieć w słowniku lub aliasach',
    ...
    */
    ...
    'attributes' => [
        'part_number'           => 'Materiał',
        'part_quantity'         => 'Ilość Materiałów',
        'container_number'      => 'Pojemnik',
        'container_quantity'    => 'Ilość Pojemników',
        'pallet_number'         => 'Paleta',
        'pallet_quantity'       => 'Ilość Palet',
        'lid_number'            => 'Dekiel',
        'lid_quantity'          => 'Ilość Dekli',

        'consecutive_number'    => 'Numer VID',
        'erp_booking_number'    => 'Numer Księgowania ERP',

        'rack'      => 'Regał',
        'level'     => 'Poziom',
        'square'    => 'Plac',

        'item.*.number'     => 'Numer Pojemnika',
        'item.*.quantity'   => 'Ilość',
    ],
